...
var akashicLibDir = path.join(__dirname, "..", "engine-src", version, "node_modules", "@akashic");
var akashicLibs = ["engine-files", "game-storage"];
var versions = {};
...
fs.writeFileSync(path.join(__dirname, "..", "engine-src", version, "external", "versions.json"), JSON.stringify(versions, null, 2));
