require = function() {
    ...
    6: [ function(require, module, exports) {
        ...
        var g = require("@akashic/akashic-engine"), Game = function(_super) {
            function Game(param) {
                ...
                _this._notifiesTargetTimeReached = !1;
                _this._isSkipAware = !1;
    ...
    8: [ function(require, module, exports) {
        ...
        var g = require("@akashic/akashic-engine"), constants = require("./constants"), LoopMode_1 = require("./LoopMode"), LoopRenderMode_1 = require("./LoopRenderMode"), ExecutionMode_1 = require("./ExecutionMode"), Clock_1 = require("./Clock"), ProfilerClock_1 = require("./ProfilerClock"), EventConverter_1 = require("./EventConverter"), TickController_1 = require("./TickController"), GameLoop = function() {
            function GameLoop(param) {
                ...
                this._game.setIsSkipAware(null == conf.skipAwareGame || conf.skipAwareGame);
            ...
            GameLoop.prototype.setLoopConfiguration = function(conf) {
                ...
                null != conf.skipAwareGame && this._game.setIsSkipAware(conf.skipAwareGame);
            ...
            GameLoop.prototype._onFrame = function(frameArg) {
                if (this._loopMode === LoopMode_1.default.Replay && this._targetTimeFunc) {
                    ...
                    prevTime === this._currentTime && prevTime <= targetTime && targetTime <= prevTime + this._frameTime && this.rawTargetTimeReachedTrigger.fire(givenTargetTime);
            ...
            GameLoop.prototype._onFrameForTimedReplay = function(targetTime, frameArg) {
                ...
                if (frameGap <= 0) this._skipping && this._stopSkipping(); else {
            ...
            GameLoop.prototype._onFrameNormal = function(frameArg) {
                ...
                if (this._waitingNextTick) this._sceneLocalMode === g.LocalTickMode.InterpolateLocal && this._doLocalTick(); else {
                    ...
                    if ((ageGap > this._jumpTryThreshold || ageGap < 0) && !this._waitingStartPoint && this._lastRequestedStartPointAge < currentAge) {
                        this._waitingStartPoint = !0;
            ...
            TickBuffer.prototype.readNextTickTime = function() {
                ...
                if (age === range.start) {
                    ...
                    for (var i = 0; i < pevs.length; ++i) if (2 === pevs[i][0]) {
                        ...
                        nextTickTime < this._oldTimestampThreshold && (nextTickTime += this._startedAt);
    ...
    21: [ function(require, module, exports) {
        ...
        var g = require("@akashic/akashic-engine"), SimpleProfiler = function() {
            function SimpleProfiler(param) {
                ...
                param.getValueHandler && this._calculateProfilerValueTrigger.add(param.getValueHandler, param.getValueHandlerOwner);
                this._reset();
            }
    ...
    22: [ function(require, module, exports) {
        ...
        exports.DEFAULT_JUMP_TRY_THRESHOLD = 3e4;
        exports.DEFAULT_JUMP_IGNORE_THRESHOLD = 15e3;
        exports.DEFAULT_POLLING_TICK_THRESHOLD = 1e4;
    }, {} ],
