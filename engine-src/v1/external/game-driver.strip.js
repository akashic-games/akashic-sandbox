        ...
        var g = require("@akashic/akashic-engine"), Clock = function() {
            ...
            Clock.prototype._onLooperCall = function(deltaTime) {
                ...
                for (var frameCount = totalDeltaTime < this._waitTimeDoubled ? 1 : totalDeltaTime > this._waitTimeMax ? this._realMaxFramePerOnce : totalDeltaTime / this._waitTime | 0, fc = frameCount, arg = {
                    interrupt: !1
                }; fc > 0 && this.running && !arg.interrupt; ) {
                    --fc;
            ...
            Clock.prototype._updateWaitTimes = function(fps, scaleFactor) {
                ...
                this._waitTime = 1e3 / realFps;
                this._waitTimeDoubled = Math.max(2e3 / realFps | 0, 1);
    ...
    2: [ function(require, module, exports) {
        ...
        var g = (require("@akashic/akashic-pdi"), require("@akashic/akashic-engine")), PointEventResolver_1 = require("./PointEventResolver"), EventBuffer = function() {
            ...
            EventBuffer.prototype.setMode = function(param) {
                ...
                if (null != param.isReceiver && this._isReceiver !== param.isReceiver) {
                ...
                null != param.isSender && (this._isSender = param.isSender);
                null != param.isDiscarder && (this._isDiscarder = param.isDiscarder);
            ...
            EventBuffer.prototype.onEvent = function(pev) {
                if (EventBuffer.isEventLocal(pev)) this._isLocalReceiver && !this._isDiscarder && this._unfilteredLocalEvents.push(pev); else {
                    this._isReceiver && !this._isDiscarder && (0 === pev[0] || 1 === pev[0] ? this._unfilteredJoinLeaves.push(pev) : this._unfilteredEvents.push(pev));
                    if (this._isSender) {
                        null == pev[1] && (pev[1] = this._defaultEventPriority);
            ...
            EventBuffer.prototype.addEventDirect = function(pev) {
                if (EventBuffer.isEventLocal(pev)) {
                    ...
                    this._localBuffer ? this._localBuffer.push(pev) : this._localBuffer = [ pev ];
                } else {
        ...
        var g = require("@akashic/akashic-engine"), EventConverter = function() {
            ...
            EventConverter.prototype.toGameEvent = function(pev) {
                ...
                switch (eventCode) {
                  ...
                  case 32:
                    local = pev[4];
                    return new g.MessageEvent(pev[3], player, local, prio);

                  case 33:
                    local = pev[7];
                    pointerId = pev[3];
                    entityId = pev[6];
                    target = null == entityId ? void 0 : entityId >= 0 ? this._game.db[entityId] : this._game._localDb[entityId];
                    point = {
                        x: pev[4],
                        y: pev[5]
                    };
            ...
            EventConverter.prototype.toPlaylogEvent = function(e, preservePlayer) {
                ...
                switch (e.type) {
                  ...
                  case g.EventType.Timestamp:
                    ...
                    return [ 2, ts.priority, playerId, ts.timestamp ];
                  ...
                  case g.EventType.PointDown:
                    ...
                    return [ 33, pointDown.priority, playerId, pointDown.pointerId, pointDown.point.x, pointDown.point.y, targetId, !!pointDown.local ];
                  ...
                  case g.EventType.PointMove:
                    ...
                    return [ 34, pointMove.priority, playerId, pointMove.pointerId, pointMove.point.x, pointMove.point.y, pointMove.startDelta.x, pointMove.startDelta.y, pointMove.prevDelta.x, pointMove.prevDelta.y, targetId, !!pointMove.local ];
                  ...
                  case g.EventType.PointUp:
                    ...
                    return [ 35, pointUp.priority, playerId, pointUp.pointerId, pointUp.point.x, pointUp.point.y, pointUp.startDelta.x, pointUp.startDelta.y, pointUp.prevDelta.x, pointUp.prevDelta.y, targetId, !!pointUp.local ];

                  case g.EventType.Message:
                    var message = e;
                    playerId = preservePlayer ? message.player.id : this._game.player.id;
                    return [ 32, message.priority, playerId, message.data, !!message.local ];

                  case g.EventType.Operation:
                    var op = e;
                    playerId = preservePlayer ? op.player.id : this._game.player.id;
                    return [ 64, op.priority, playerId, op.code, op.data, !!op.local ];
    ...
    6: [ function(require, module, exports) {
        ...
        var g = require("@akashic/akashic-engine"), Game = function(_super) {
            ...
            Game.prototype.saveSnapshot = function(gameSnapshot, timestamp) {
                void 0 === timestamp && (timestamp = this._getCurrentTimeFunc());
    ...
    7: [ function(require, module, exports) {
        ...
        var es6_promise_1 = require("es6-promise"), g = require("@akashic/akashic-engine"), ExecutionMode_1 = require("./ExecutionMode"), Game_1 = require("./Game"), EventBuffer_1 = require("./EventBuffer"), GameLoop_1 = require("./GameLoop"), PdiUtil_1 = require("./PdiUtil"), GameDriver = function() {
            ...
            GameDriver.prototype.changeState = function(param, callback) {
                ...
                pausing && this._gameLoop.stop();
                this.initialize(param, function(err) {
                    if (err) callback(err); else {
                        pausing && _this._gameLoop.start();
                        callback();
                    }
                });
            };
            GameDriver.prototype.startGame = function() {
                this._gameLoop ? this._gameLoop.start() : this.errorTrigger.fire(new Error("Not initialized"));
            };
            ...
            GameDriver.prototype.doInitialize = function(param) {
                var _this = this, p = new es6_promise_1.Promise(function(resolve, reject) {
                    if (_this._gameLoop && _this._gameLoop.running) return reject(new Error("Game is running. Must be stopped."));
                    _this._gameLoop && param.loopConfiguration && _this._gameLoop.setLoopConfiguration(param.loopConfiguration);
                    if (null != param.hidden) {
                        _this._hidden = param.hidden;
                        _this._game && _this._game._setMuted(param.hidden);
                    }
                    resolve();
                }).then(function() {
            ...
            GameDriver.prototype.destroy = function() {
                ...
                return new es6_promise_1.Promise(function(resolve, reject) {
                    ...
                    _this._platform.setRendererRequirement(void 0);
            ...
            GameDriver.prototype._doSetDriverConfiguration = function(dconf) {
                ...
                void 0 === dconf.playId && (dconf.playId = this._playId);
                void 0 === dconf.playToken && (dconf.playToken = this._playToken);
                ...
                this._playId !== dconf.playId && (p = p.then(function() {
                ...
                return p.then(function() {
                    return new es6_promise_1.Promise(function(resolve, reject) {
                        if (null != dconf.eventBufferMode) {
                            null == dconf.eventBufferMode.defaultEventPriority && (dconf.eventBufferMode.defaultEventPriority = _this._permission.maxEventPriority);
                            _this._eventBuffer && _this._eventBuffer.setMode(dconf.eventBufferMode);
                        }
                        null != dconf.executionMode && _this._gameLoop && _this._gameLoop.setExecutionMode(dconf.executionMode);
                        resolve();
                    });
                });
            };
            GameDriver.prototype._doCloseAmflow = function() {
                var _this = this;
                return new es6_promise_1.Promise(function(resolve, reject) {
                    if (!_this._openedAmflow) return resolve();
            ...
            GameDriver.prototype._doOpenAmflow = function(playId) {
                ...
                return p.then(function() {
                    return new es6_promise_1.Promise(function(resolve, reject) {
                        if (null === playId) return resolve();
                        _this._platform.amflow.open(playId, function(err) {
                            if (err) return reject(err);
                            _this._openedAmflow = !0;
                            _this._playId = playId;
                            _this._game && _this._updateGamePlayId(_this._game);
                            resolve();
                        });
                    });
                });
            ...
            GameDriver.prototype._doAuthenticate = function(playToken) {
                ...
                return null == playToken ? es6_promise_1.Promise.resolve() : new es6_promise_1.Promise(function(resolve, reject) {
                    _this._platform.amflow.authenticate(playToken, function(err, permission) {
                        ...
                        _this._game && (_this._game.isSnapshotSaver = _this._permission.writeTick);
                        resolve();
                    });
                });
            };
            ...
            GameDriver.prototype._getZerothStartPointData = function() {
                ...
                return new es6_promise_1.Promise(function(resolve, reject) {
                    _this._platform.amflow.getStartPoint({
                        ...
                        if ("number" != typeof data.seed) return reject(new Error("GameDriver#_getRandomSeed: No seed found."));
                        resolve(data);
                    });
                });
            };
            GameDriver.prototype._createGame = function(conf, player, param) {
                ...
                p = putSeed ? this._putZerothStartPoint({
                    seed: Date.now(),
                ...
                return p.then(function(zerothData) {
                    ...
                    _this._hidden && game._setMuted(!0);
                    game.snapshotTrigger.handle(function(startPoint) {
    ...
    8: [ function(require, module, exports) {
        ...
        var g = require("@akashic/akashic-engine"), LoopMode_1 = require("./LoopMode"), LoopRenderMode_1 = require("./LoopRenderMode"), ExecutionMode_1 = require("./ExecutionMode"), Clock_1 = require("./Clock"), ProfilerClock_1 = require("./ProfilerClock"), EventConverter_1 = require("./EventConverter"), TickController_1 = require("./TickController"), GameLoop = function() {
            function GameLoop(param) {
                ...
                this._targetAge = null != conf.targetAge ? conf.targetAge : null;
                this._waitingStartPoint = !1;
            ...
            GameLoop.prototype.setLoopConfiguration = function(conf) {
                null != conf.loopMode && (this._loopMode = conf.loopMode);
                null != conf.delayIgnoreThreshold && (this._delayIgnoreThreshold = conf.delayIgnoreThreshold);
                null != conf.skipTicksAtOnce && (this._skipTicksAtOnce = conf.skipTicksAtOnce);
                null != conf.skipThreshold && (this._skipThreshold = conf.skipThreshold);
                ...
                if (null != conf.playbackRate) {
                    this._playbackRate = conf.playbackRate;
                    this._clock.changeScaleFactor(this._playbackRate);
                    this._updateGamePlaybackRate();
                }
                null != conf.loopRenderMode && this._setLoopRenderMode(conf.loopRenderMode);
                null != conf.targetTimeFunc && (this._targetTimeFunc = conf.targetTimeFunc);
                null != conf.targetTimeOffset && (this._targetTimeOffset = conf.targetTimeOffset);
                null != conf.originDate && (this._originDate = conf.originDate);
                this._realTargetTimeOffset = null != this._originDate ? this._originDate - this._startedAt : this._targetTimeOffset || 0;
                if (null != conf.targetAge) {
                    this._targetAge !== conf.targetAge && (this._waitingNextTick = !1);
            ...
            GameLoop.prototype._startSkipping = function() {
                this._skipping = !0;
                this._updateGamePlaybackRate();
                this._game.skippingChangedTrigger.fire(!0);
            };
            GameLoop.prototype._stopSkipping = function() {
                this._skipping = !1;
                this._updateGamePlaybackRate();
                this._game.skippingChangedTrigger.fire(!1);
            };
            ...
            GameLoop.prototype._onFrameForTimedReplay = function(frameArg) {
                ...
                if ((frameGap > this._jumpTryThreshold || frameGap < 0) && !this._waitingStartPoint && this._lastRequestedStartPointTime < this._currentTime) {
                    this._waitingStartPoint = !0;
                    this._lastRequestedStartPointTime = targetTime;
                    this._amflow.getStartPoint({
                        timestamp: targetTime
                    }, this._onGotStartPoint_bound);
                }
                this._skipping ? frameGap <= 1 && this._stopSkipping() : frameGap > this._skipThreshold && this._startSkipping();
                if (!(frameGap <= 0)) for (var i = 0; i < this._skipTicksAtOnce; ++i) {
                    ...
                    null == nextTickTime && (nextTickTime = nextFrameTime);
            ...
            GameLoop.prototype._onFrameNormal = function(frameArg) {
                ...
                if (this._waitingNextTick) this._sceneLocalMode === g.LocalTickMode.InterpolateLocal && this._doLocalTick(); else {
                    ...
                    if ((ageGap > this._jumpTryThreshold || ageGap < 0) && !this._waitingStartPoint && this._lastRequestedStartPointAge < this._tickBuffer.currentAge) {
                        this._waitingStartPoint = !0;
                    ...
                    if (ageGap <= 0) {
                        if (0 === ageGap) {
                            this._sceneTickMode !== g.TickGenerationMode.Manual && this._loopMode !== LoopMode_1.default.Replay || 0 !== this._tickBuffer.currentAge || this._tickBuffer.requestTicks();
                            this._startWaitingNextTick();
                        }
                        this._sceneLocalMode === g.LocalTickMode.InterpolateLocal && this._doLocalTick();
                    } else for (var loopCount = !this._skipping && ageGap <= this._delayIgnoreThreshold ? 1 : Math.min(ageGap, this._skipTicksAtOnce), i = 0; i < loopCount; ++i) {
                        var nextFrameTime = this._currentTime + this._frameTime, nextTickTime = this._tickBuffer.readNextTickTime();
            ...
            GameLoop.prototype._onGotStartPoint = function(err, startPoint) {
                this._waitingStartPoint = !1;
                if (err) this.errorTrigger.fire(err); else {
            ...
            GameLoop.DEFAULT_DELAY_IGNORE_THRESHOLD = 6;
            GameLoop.DEFAULT_SKIP_TICKS_AT_ONCE = 100;
            GameLoop.DEFAULT_SKIP_THRESHOLD = 3e4;
            GameLoop.DEFAULT_JUMP_TRY_THRESHOLD = 9e4;
            GameLoop.DEFAULT_JUMP_IGNORE_THRESHOLD = 15e3;
            GameLoop.DEFAULT_POLLING_TICK_THRESHOLD = 1e4;
    ...
    9: [ function(require, module, exports) {
        ...
        var g = require("@akashic/akashic-engine"), JoinLeaveRequest = function() {
            function JoinLeaveRequest(pev, joinResolver, amflow, keys) {
                ...
                } else this.resolved = !0;
            }
            JoinLeaveRequest.prototype._onGotStorageData = function(err, sds) {
                this.resolved = !0;
                err ? this.joinResolver.errorTrigger.fire(err) : this.pev[4] = sds;
            };
    ...
    13: [ function(require, module, exports) {
        ...
        var PointEventResolver = function() {
            ...
            PointEventResolver.prototype.pointDown = function(e) {
                ...
                source.local && ret.push(source.local);
                return ret;
            };
            PointEventResolver.prototype.pointMove = function(e) {
                ...
                holder.local && ret.push(holder.local);
                return ret;
            };
    ...
    14: [ function(require, module, exports) {
        ...
        var Clock_1 = require("./Clock"), ProfilerClock = function(_super) {
            ...
            ProfilerClock.prototype._onLooperCall = function(deltaTime) {
                ...
                this._profiler.timeEnd(1);
                this._profiler.time(1);
                ...
                this._profiler.setValue(0, fc - 1);
                for (;fc > 0 && this.running && !arg.interrupt; ) {
                    --fc;
                    this._profiler.time(2);
                    this.frameTrigger.fire(arg);
                    this._profiler.timeEnd(2);
                }
                totalDeltaTime -= (frameCount - fc) * this._waitTime;
                this._profiler.time(3);
                this.rawFrameTrigger.fire();
                this._profiler.timeEnd(3);
                this._totalDeltaTime = totalDeltaTime;
    ...
    15: [ function(require, module, exports) {
        ...
        var g = require("@akashic/akashic-engine"), ExecutionMode_1 = require("./ExecutionMode"), StorageResolver = function() {
            ...
            StorageResolver.prototype._onGotStorageOnTick = function(storageOnTick) {
                ...
                } else this._unresolvedStorages[resolvingAge] = storageData;
            };
            StorageResolver.prototype._getStorage = function(keys, loader, ser) {
                ...
                } else if (this._executionMode === ExecutionMode_1.default.Active) resolvingAge = this._tickGenerator.requestStorageTick(keys); else {
                    resolvingAge = this._game.age;
                    this._tickBuffer.requestTicks(resolvingAge, 1);
                }
                ...
                if (sd) {
                    ...
                    loader._onLoaded(values, serialization);
                } else this._unresolvedLoaders[resolvingAge] = loader;
            };
        ...
        var g = require("@akashic/akashic-engine"), ExecutionMode_1 = require("./ExecutionMode"), TickBuffer = function() {
            ...
            TickBuffer.prototype.setExecutionMode = function(execMode) {
                if (this._executionMode !== execMode) {
                    this._dropUntil(this.knownLatestAge + 1);
                    this._nextTickTimeCache = null;
                    this._nearestAbsentAge = this.currentAge;
                    this._executionMode = execMode;
                    this._updateAmflowReceiveState();
            ...
            TickBuffer.prototype.consume = function() {
                ...
                if (age === range.start) {
                    ...
                    ++this.currentAge;
                    ++range.start;
                    age + this._prefetchThreshold === this._nearestAbsentAge && this.requestTicks(this._nearestAbsentAge, this._sizeRequestOnce);
                    range.start === range.end && this._tickRanges.shift();
                    return range.ticks.length > 0 && range.ticks[0][0] === age ? range.ticks.shift() : age;
                }
            ...
            TickBuffer.prototype.readNextTickTime = function() {
                ...
                if (age === range.start) {
                    ...
                    for (var i = 0; i < pevs.length; ++i) if (2 === pevs[i][0]) {
                        this._nextTickTimeCache = pevs[i][3];
            ...
            TickBuffer.prototype.requestTicks = function(from, len) {
                void 0 === from && (from = this.currentAge);
                void 0 === len && (len = this._sizeRequestOnce);
            ...
            TickBuffer.prototype.addTick = function(tick) {
                ...
                this.knownLatestAge < age && (this.knownLatestAge = age);
                ...
                if (i < 0) this._tickRanges.unshift(this._createTickRangeFromTick(tick)); else {
                    ...
                    if (age === range.end) {
                        ++range.end;
                        tick[1] && range.ticks.push(tick);
                    } else age > range.end && this._tickRanges.splice(i + 1, 0, this._createTickRangeFromTick(tick));
                }
                if (this._nearestAbsentAge === age) {
                    ++this._nearestAbsentAge;
                    nextRange && this._nearestAbsentAge === nextRange.start && (this._nearestAbsentAge = this._findNearestAbscentAge(this._nearestAbsentAge));
                }
            ...
            TickBuffer.prototype.addTickList = function(tickList) {
                ...
                ticks || (ticks = []);
                origStart === start && origEnd === end || (ticks = ticks.filter(function(tick) {
                    var age = tick[0];
                ...
                start <= this._nearestAbsentAge && this._nearestAbsentAge < end && (this._nearestAbsentAge = this._findNearestAbscentAge(this._nearestAbsentAge));
                return range;
            };
            ...
            TickBuffer.prototype._dropUntil = function(age) {
                ...
                if (0 !== this._tickRanges.length) {
                    var range = this._tickRanges[0];
                    if (!(age < range.start)) {
                        range.start = age;
                        for (i = 0; i < range.ticks.length && !(age <= range.ticks[i][0]); ++i) ;
            ...
            TickBuffer.DEFAULT_PREFETCH_THRESHOLD = 1800;
            TickBuffer.DEFAULT_SIZE_REQUEST_ONCE = 9e3;
            return TickBuffer;
        }();
        ...
        var g = require("@akashic/akashic-engine"), JoinResolver_1 = require("./JoinResolver"), TickGenerator = function() {
            ...
            TickGenerator.prototype.next = function() {
                if (this._generatingTick && !this._waitingStorage) {
                    ...
                    this._storageDataForNext = null;
                    this.tickTrigger.fire([ this._nextAge++, evs, sds ]);
                }
            };
            TickGenerator.prototype.forceNext = function() {
                if (this._waitingStorage) this.errorTrigger.fire(new Error("TickGenerator#forceNext(): cannot generate tick while waiting storage.")); else {
            ...
            TickGenerator.prototype.setNextAge = function(age) {
                this._waitingStorage ? this.errorTrigger.fire(new Error("TickGenerator#setNextAge(): cannot change the next age while waiting storage.")) : this._nextAge = age;
            };
    ...
    19: [ function(require, module, exports) {
        ...
        var MemoryAmflowClient = function() {
            ...
            MemoryAmflowClient.prototype.open = function(playId, callback) {
                var _this = this;
                setTimeout(function() {
                    if (playId !== _this._playId) return void callback(new Error("MemoryAmflowClient#open: unknown playId"));
                    callback();
                }, 0);
            };
            ...
            MemoryAmflowClient.prototype.sendTick = function(tick) {
                ...
                (tick[1] || tick[2]) && this._tickList[2].push(tick);
                this._tickHandlers.forEach(function(h) {
                    return h(tick);
                });
            };
            ...
            MemoryAmflowClient.prototype.sendEvent = function(pev) {
                0 !== this._eventHandlers.length ? this._eventHandlers.forEach(function(h) {
                    return h(pev);
            ...
            MemoryAmflowClient.prototype.getTickList = function(from, to, callback) {
                ...
                from = Math.max(from, this._tickList[0]);
                to = Math.min(to, this._tickList[1]);
    ...
    20: [ function(require, module, exports) {
        ...
        var ReplayAmflowProxy = function() {
            ...
            ReplayAmflowProxy.prototype.dropAfter = function(age) {
                if (this._tickList) {
                    ...
                    if (age <= givenFrom) {
                        ...
                        this._tickList[1] = age - 1;
                        this._tickList[2] = this._sliceTicks(givenTicksWithEvents, givenTo, age - 1);
                        this._startPoints = this._startPoints.filter(function(sp) {
                            return sp.frame < age;
                        });
                    }
            ...
            ReplayAmflowProxy.prototype.getTickList = function(from, to, callback) {
                ...
                } else this._amflow.getTickList(from, to, callback);
            };
            ...
            ReplayAmflowProxy.prototype.getStartPoint = function(opts, callback) {
                ...
                opts.frame > givenTo ? this._amflow.getStartPoint(opts, function(err, startPoint) {
                    err ? callback(err) : givenTo < startPoint.frame ? callback(null, startPoint) : callback(null, _this._startPoints[index]);
                }) : setTimeout(function() {
                    callback(null, _this._startPoints[index]);
                }, 0);
            };
    ...
    21: [ function(require, module, exports) {
        ...
        var g = require("@akashic/akashic-engine"), SimpleProfiler = function() {
            function SimpleProfiler(param) {
                ...
                param.getValueHandler && this._calculateProfilerValueTrigger.handle(param.getValueHandlerOwner, param.getValueHandler);
                this._reset();
            }
            ...
            SimpleProfiler.prototype.flush = function() {
                ...
                0 === this._beforeFlushTime && (this._beforeFlushTime = now);
                ...
                if (this._values[1].length > this._limit) for (var i in this._values) this._values.hasOwnProperty(i) && (this._values[i] = this._values[i].slice(-SimpleProfiler.BACKUP_MARGIN));
            };
            ...
            SimpleProfiler.prototype._reset = function() {
                ...
                this._beforeTimes = [];
                this._beforeTimes[1] = 0;
                this._beforeTimes[2] = 0;
                this._beforeTimes[3] = 0;
                this._beforeTimes[0] = 0;
                this._values = [];
                this._values[1] = [];
                this._values[2] = [];
                this._values[3] = [];
            ...
            SimpleProfiler.DEFAULT_INTERVAL = 1e3;
            SimpleProfiler.DEFAULT_LIMIT = 1e3;
 ...
 */
            !function(global, factory) {
                ...
                function Enumerator(Constructor, input) {
                    ...
                    } else _reject(this.promise, validationError());
                }
